...
export default function App() {
  ...
  const [bestellingen, setBestellingenRaw] = useState(() => load("sr:bestellingen", []));
  ...
  function setBestellingen(val) { setBestellingenRaw(val); save("sr:bestellingen", val); }
  ...
  if (session.role === "admin") {
    return <AdminPortal klanten={klanten} setKlanten={setKlanten} soepen={soepen} setSoepen={setSoepen} weekMenu={weekMenu} setWeekMenu={setWeekMenu} bestellingen={bestellingen} setBestellingen={setBestellingen} onLogout={handleLogout} />;
  }
  ...
  return <KlantPortal
    ...
    setBestellingen={setBestellingen}
